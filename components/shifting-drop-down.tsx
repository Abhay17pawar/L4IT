...
export const ShiftingDropDown = () => {
  return (
    <div className="sticky top-0 z-50 w-full bg-opacity-90 backdrop-blur p-4">
      <div className="flex justify-start md:justify-center text-neutral-200">
        <Tabs />
      </div>
    </div>
  )
...
const Products = () => {
  return (
    <div>
      ...
      <button className="ml-auto mt-4 flex items-center gap-1 text-sm text-rose-300">
        <span>View more</span>
        <FiArrowRight />
      </button>
    </div>
...
const Pricing = () => {
  return (
    <div className="grid grid-cols-3 gap-4 divide-x divide-neutral-700">
      ...
      >
        <FiHome className="mb-2 text-xl text-rose-300" />
      ...
      <a
        ...
        className="flex w-full flex-col items-center justify-center py-2 text-neutral-400 transition-colors hover:text-neutral-50"
      >
        <FiBarChart2 className="mb-2 text-xl text-rose-300" />
      ...
      <a
        ...
        className="flex w-full flex-col items-center justify-center py-2 text-neutral-400 transition-colors hover:text-neutral-50"
      >
        <FiPieChart className="mb-2 text-xl text-rose-300" />
